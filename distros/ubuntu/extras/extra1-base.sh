...
commit_patch(){
  ...
  local PACKAGES=(software-properties-common neofetch htop nano vim curl wget man-db openssh-server bash-completion ca-certificates sudo software-properties-common nfs-common)
